package ma.boumlyk.onboarding.data.sources.remote;
...
public class PrintingEventListener extends EventListener {
    public static final Factory FACTORY = new Factory() {
        ...
        @Override public EventListener create(Call call) {
            ...
            System.out.printf("PrintingEventListener -- %04d %s%n", callId, call.request().url());
    ...
    @Override public void proxySelectEnd(Call call, HttpUrl url, List<Proxy> proxies) {
        ...
        printEvent("proxySelectEnd:"+proxies);
